...
export function NoteForm({isEditable=true,note,title , onClickEdit, onClickDelete, onSubmit}){
    ...
    const validate = (fieldName,fieldValue)=>{
        setFormErrors({
            ...formErrors, [fieldName]: VALIDATOR[fieldName](fieldValue),
        })
    }
    ...
    const titleInput=(
        <div className="mb-5">
            ...
            <input value={formValues.title} onChange={updateFormValue} type="text" name="title" className="form-control"/>
    ...
    const contentInput=(
        <div className="mb-5">
            ...
            <textarea value={formValues.content}  onChange={updateFormValue} type="text" name="content" className="form-control" row="5"/>
    ...
    return (
        <div className={s.container}>
            ...
            <div className="mb-3">
                {isEditable ? contentInput : <pre>{note && note.content}</pre>}
            </div>
            {onSubmit&&submitBtn}
        </div>
    );
